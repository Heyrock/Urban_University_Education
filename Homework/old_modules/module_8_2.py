...
#
# 1. Должна принимать коллекцию numbers и возвращать:
...
# 3. Вызовите функцию calculate_average несколько раз, передав в неё данные
# разных вариаций.
#
...
# чтобы вы больше экспериментировали.
...
print(f'Результат 1: {calculate_average("1, 2, 3")}') # 0
# Строка перебирается, но каждый символ - строковый тип
print(f'Результат 2: {calculate_average([1, "Строка", 3, "Ещё Строка"])}') # 2.0
# Учитываются только 1 и 3
print(f'Результат 3: {calculate_average(567)}') # None
# Передана не коллекция
