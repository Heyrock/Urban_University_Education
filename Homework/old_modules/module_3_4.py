...
# Пункты задачи:
#
# 1. Объявите функцию single_root_words и напишите в ней параметры root_word
# и *other_words.
# 2. Создайте внутри функции пустой список same_words, который пополнится
# нужными словами.
...
# символов не должен влиять ни на что. ('Disablement' - 'Able')
...
def single_root_words(root_word, *other_words):
    ...
    for i in other_words:
        if i.lower() in root_word.lower() or root_word.lower() in i.lower():
            same_words.append(i)
    # Как вариант с List Comprehensions
    # same_words = [
    #     i for i in other_words
