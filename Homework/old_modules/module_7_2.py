...
#
# Функция должна:
# 1. Записывать в файл file_name все строки из списка strings,
...
# 3. Помните, что при использовании символов не принадлежащих таблице ASCII,
# вы используете больше байт для записи символа.
# Соответственно для чтения и записи информации из/в файл(-f) потребуется
# другая кодировка - utf-8.
